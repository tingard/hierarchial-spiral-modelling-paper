...
We do not correct for variation in bulge size in this work, however, predictions from Manifold theory should not be affected as bulges do not provide a strong non-axisymmetric forcing. The fact that we do not find any link between bar strength and pitch angle suggests that the primary mechanism driving the evolution of the spirals in our sample is not Manifold theory.
